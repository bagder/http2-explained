...
curl supports a wide range of different TLS libraries for its TLS back-end, and that is still valid for http2 support. The challenge with using TLS for http2 is the ALPN support and to some extent NPN support.
